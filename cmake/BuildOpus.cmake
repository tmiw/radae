...
if (CMAKE_CROSSCOMPILING)
    ...
    set(CONFIGURE_X86_CC CC=x86_64-apple-darwin24-clang CXX=x86_64-apple-darwin24-clang++ LD=x86_64-apple-darwin24-ld)
    set(CONFIGURE_ARM_CC CC=aarch64-apple-darwin24-clang CXX=aarch64-apple-darwin24-clang++ LD=aarch64-apple-darwin24-ld)
...
ExternalProject_Add(build_opus_x86
    ...
    CONFIGURE_COMMAND ./autogen.sh && ${CONFIGURE_X86_CC} ./configure --enable-dred --disable-shared --disable-doc --disable-extra-program --host=x86_64-${ARCH_SUFFIX} --target=x86_64-${ARCH_SUFFIX} CFLAGS=-arch\ x86_64\ -O2\ -mmacosx-version-min=10.11
    BUILD_COMMAND $(MAKE)
    INSTALL_COMMAND ""
    URL ${OPUS_URL}
)
ExternalProject_Add(build_opus_arm
    ...
    BUILD_IN_SOURCE 1
    PATCH_COMMAND sh -c "patch dnn/nnet.h < ${CMAKE_SOURCE_DIR}/src/opus-nnet.h.diff"
    CONFIGURE_COMMAND ./autogen.sh && ${CONFIGURE_ARM_CC} ./configure --enable-dred --disable-shared --disable-doc --disable-extra-program --host=aarch64-${ARCH_SUFFIX} --target=aarch64-${ARCH_SUFFIX} CFLAGS=-arch\ arm64\ -O2\ -mmacosx-version-min=10.11
    BUILD_COMMAND $(MAKE)
    INSTALL_COMMAND ""
    URL ${OPUS_URL}
)
